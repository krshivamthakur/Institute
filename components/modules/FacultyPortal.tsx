                  ...
                  {slot.meetingLink ? (
                    <div className="mt-2 space-y-1">
                      <a
                        ...
                        className="w-full py-2 rounded-xl bg-indigo-600/20 hover:bg-indigo-600 text-indigo-300 hover:text-white font-bold text-xs border border-indigo-500/30 transition flex items-center justify-center gap-1.5 shadow-sm group/btn"
                      >
                        <Video className="h-4 w-4 text-indigo-400 group-hover/btn:animate-pulse" /> Launch Virtual Classroom Link
                      </a>
                      <p className="text-[10px] text-indigo-400/80 font-mono text-center truncate">
                        🔗 {slot.meetingLink}
                      </p>
                    </div>
                  ) : (
                    <div className="mt-2 py-1.5 text-center text-[10px] text-slate-500 bg-slate-900/50 rounded-lg">
                      Physical In-Person Lecture
                    </div>
                  )}
                </div>
              ))}
